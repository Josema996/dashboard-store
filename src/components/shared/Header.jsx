...
const Header = () => {
  return (
     ...
     <div>
       ...
       <p className="text-gray-500">09 Agosto 2022</p>
     </div>
     <form>
     ...
     <nav className="text-gray-300 flex items-center justify-between md:justify-start md:gap-8 border-b mb-6">
       <a href="#" className="relative py-2 pr-4 before:w-1/2 before:h-[2px] before:absolute before:bg-[#ec7c6a] before:le-0 before:rounded-full before:-bottom-[1px] text-[#ec7c6a] ">Hot dishes</a>
