...
const Card = (props) => {
  ...
  return (
    ...
    ${showOrder ? "right-0" : "-rigth-full"}`}>
      {/*Orders*/}
      <div className="relative pt-16 p-8 text-gray-300 p-8 h-full">
        ...
        <div className="bg-[#262837] p-4 rounded-xl mb-4">
          <div className="grid grid-cols-6 mb-4">
            ...
            <div className="col-span-4 flex items-center gap-3">
              ...
              <div>
                <h5 className="text-sm">Spaci seaso...</h5>
         ...
         <div className="bg-[#262837] p-4 rounded-xl mb-4">
          <div className="grid grid-cols-6 mb-4">
            {/*Description product */}
            <div className="col-span-4 flex items-center gap-3">
                <img src="comida3.png" className="w-10 h-10 object-cover" />
              <div>
                <h5 className="text-sm">Margarita piz...</h5>
                <p className="text-xs text-gray-500">$5.29</p>
              </div>
            </div>
            {/* Qty */}
            <div>
         ...
         <div className="bg-[#262837] p-4 rounded-xl mb-4">
          <div className="grid grid-cols-6 mb-4">
            {/*Description product */}
            <div className="col-span-4 flex items-center gap-3">
                <img src="comida2.png" className="w-10 h-10 object-cover" />
              <div>
                <h5 className="text-sm">Curry wit...</h5>
                <p className="text-xs text-gray-500">$1.29</p>
              </div>
            </div>
            {/* Qty */}
            <div>
