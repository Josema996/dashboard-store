          ...
          <div className="h-[400px] md:h-[700px] lg:h-[540px] overflow-scroll">
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                ...
                <div className="col-span-4 flex items-center gap-3">
                  <img src="comida4.png" className="w-10 h-10 object-cover" />
                  <div>
                    <h5 className="text-sm">Mixed sal...</h5>
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                {/* Product description */}
                <div className="col-span-4 flex items-center gap-3">
                  <img src="comida5.png" className="w-10 h-10 object-cover" />
                  <div>
                    <h5 className="text-sm">Chickpea pur...</h5>
